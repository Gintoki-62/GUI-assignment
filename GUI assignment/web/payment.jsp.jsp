...
<body class="animsition">
	...
	<section class="bg0 p-t-52 p-b-20">
		...
		<div class="container">
                    <img src="images/icons/replay.png" title="Back"/>
                    <div>
                            <h1 class="mtext-113 cl2 p-b-12">Check Out</h1>
                                ...
                                <table rows="2" columns="2" width="100%">
                                    ...
                                    <tr>
                                        <td>
                                            <label>Address:</label>   
                                            <div class="bor19 m-b-20">
                                                <input type="textarea" name="address" required><br>
                                            </div>
                                        </td>
                                        <td>
                                            <button class="flex-c-m stext-101 cl0 size-125 bg3 bor2 hov-btn3 p-lr-15 trans-04" style="margin-left: 30px">
                                                Edit
                                            </button>
                                        </td>
                                    </tr>
